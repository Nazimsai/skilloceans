...
const quizData = [
	{
    question: "This type of projection is when projectors are parallel to each other, but are at an angle other than 90 degrees to the plane of projection",
	a: " Oblique projection.",   	b: " Perpendicular projection.",
	c: " Aesthetic projection.",	        d: " Angular projection",
	correct:"a", 
	},
	{
question: "Generally, the units used on an architectural drawing are set to __________.",
...
question: "A line drawn with a long section, short dash, and another long section is a __________.",
	a: " Hidden feature",	     			b: "Center of a circle",
	c: "Center axis of a hidden cylinder",				d: "Center of a radius",
	correct:"c",
	}, 
	{
question: "Before starting an isometric drawing in Auto-CAD the drafter needs to ________.",
	a: " Set the grid to isometric",			b: "Set the current layer to Def-points",
	c: "Turn Object Snap off",	d: "Turn Ortho off",
	correct:"a",
	},
	{
question: "A cylinder can be created by drawing a rectangular shape then the ________ tool.",
	a: "Revolve",		b: " Sweep",
	c: "Extrude",		d: "None of the above",
	correct:"a",
	},
	{
question: "The text height for room names should be set to ________for a drawing that will be plotted to a scale of ¼ = 1'-0 ",
	a: "4",			b: "5",
	c: "6",     			d: "8",
	correct:"c",
	},
	{
question: "In order to convert fractional inches into decimal inches __________.",
	a: "Look on a metric conversion chart",				b: " Divide the numerator (top number) by the denominator (bottom number)",
	c: "Check the engineer's scale",				d: "All of the above",
	correct:"b",
	},
	{
question: "When lettering a CAD drawing, for clarity you should limit the number of fonts to:",
	a: "One",			b: "Two",
	c: "Three",			d: "Any number",
	correct:"b",
	},
	{
question: " The Offset tool should only be used for placing _________ in an isometric drawing.",
	a: "Circles",				b: "Horizontal lines",
	c: " Vertical lines",			d: "None of the above",
	correct:"c",
	},
	{
question: "The Conceptual Visual Style tool is located on the ________ toolbar.",
	a:" Visual Styles",				b:" Modify",
	c:"3-D Modeling",			d:" All of the above",
	correct:"a",
	},
	{
question: "The first step in creating a traditional technical drawing is to ________.",
	a:"Draw a series of guide lines",			b:"Set up the meter line",
	c:"Align the paper so that it will be positioned square to the parallel bar",			d:"Sharpen the leads in the technical pens",
	correct:"c",
	},
	{
question: "The primary unit of measurement for engineering drawings and design in the MECHANICAL industries is the:",
	a:"Millimeter",			b:"Centimeter",
	c:"Meter",			d:" Kilometer",
	correct:"a",
	},
	{
question: "In order to create an isometric circle to represent a hole through the top surface of a box, the drafter must insure that the correct iso-plane has been selected by scrolling through the iso-planes using the ________ key.",
	a:"F1",		b:"F3",
	c:"F5",d:"F8",
	correct:"c",
	},
	{
question: "The default position of the UCS icon is positioned at ________ on the Auto-CAD grid.",
	a:" 0, 0, 0",b:"10, 10, 10",
	c:" 20, 20, 20",	d:"All of the above",
	correct:"a",
	},
// 	{
